...
export const metadata: Metadata = {
  ...
  description:
    'Join our founding team! Teaching and administrative positions available at Himriti Public School. Competitive salary, professional development, and work in the beautiful Himalayas.',
  keywords:
