  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] flex items-center justify-center px-6">
      <div className="max-w-md mx-auto text-center">
        ...
        <h2 className="text-2xl font-bold text-[#2d3748] mb-4">Page Not Found</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <Link href="/about" className="text-[#1f514c] hover:underline text-sm">
                About
              </Link>
              <Link href="/academics" className="text-[#1f514c] hover:underline text-sm">
                Academics
              </Link>
              <Link href="/admissions" className="text-[#1f514c] hover:underline text-sm">
                Admissions
              </Link>
              <Link href="/contact" className="text-[#1f514c] hover:underline text-sm">
                Contact
              </Link>
            </div>
          </div>
