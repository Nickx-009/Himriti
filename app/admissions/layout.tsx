...
export const metadata: Metadata = {
  ...
  description:
    'Admissions open for 2026-27 academic year at Himriti Public School, Rampur Bushahr. K-12 enrollment, application process, fee structure, important dates, and financial aid information.',
  keywords:
