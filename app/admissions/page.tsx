        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 fade-in-section">
            ...
            <p className="text-xl text-[#4a5568] max-w-3xl mx-auto leading-relaxed">
              Mark your calendar with these key dates for the admission process. Early application
              is encouraged as spaces are limited.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-[#4a5568]">
                    Completed application form with student photograph
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#1f514c] mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#1f514c] mt-0.5 flex-shrink-0" />
                  <span className="text-[#4a5568]">
                    Academic transcripts from previous school (if applicable)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#1f514c] mt-0.5 flex-shrink-0" />
            ...
            <Card className="bg-white border-0 shadow-lg rounded-2xl p-8 interactive-card">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#2d5a27] mt-0.5 flex-shrink-0" />
                  <span className="text-[#4a5568]">
                    Parent-student interview (virtual or in-person)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#2d5a27] mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#2d5a27] mt-0.5 flex-shrink-0" />
                  <span className="text-[#4a5568]">
                    Reference check from previous school (if applicable)
                  </span>
                </li>
              </ul>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 fade-in-section">
            ...
            <p className="text-xl text-[#4a5568] max-w-3xl mx-auto leading-relaxed">
              We welcome students across all grade levels, with specific requirements and
              expectations tailored to each developmental stage.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#faf7f2]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 fade-in-section">
            ...
            <p className="text-xl text-[#4a5568] max-w-3xl mx-auto leading-relaxed">
              Follow these simple steps to complete your application. Our admissions team is here to
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 fade-in-section">
            ...
            <p className="text-xl text-[#4a5568] max-w-3xl mx-auto leading-relaxed">
              We believe quality education should be accessible to all deserving students. Our fee
              structure is designed to be transparent and fair.
            </p>
          </div>

          <Card className="bg-[#faf7f2] border-0 shadow-lg rounded-2xl p-8 interactive-card fade-in-section">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-[#1f514c]/10 rounded-2xl flex items-center justify-center">
                <FileText className="h-8 w-8 text-[#1f514c]" />
              </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/50">
                    <th className="text-left py-3 px-2 text-[#2d3748] font-semibold w-1/6">
                      Class Level
                    </th>
                    <th className="text-center py-3 px-2 text-[#2d3748] font-semibold w-1/6">
                      Monthly Tuition (₹)
                    </th>
                    <th className="text-center py-3 px-2 text-[#2d3748] font-semibold w-1/6">
                      Annual Tuition (₹)
                ...
                <tbody className="space-y-2">
                  ...
                  <tr className="border-b border-white/30">
                    <td className="py-3 px-2 text-[#4a5568] font-medium">
                      Kindergarten (Nur + KG)
                    </td>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12 fade-in-section">
            <Card className="bg-[#faf7f2] border-0 shadow-lg rounded-2xl p-8 interactive-card">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-[#d4831f]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Award className="h-8 w-8 text-[#d4831f]" />
                </div>
                <h3 className="text-xl font-bold text-[#2d3748] mb-2">Annual Payment Discount</h3>
                <p className="text-sm text-[#4a5568]">Save with advance payment</p>
              </div>
              <div className="text-center mb-6">
                ...
                <p className="text-[#4a5568] leading-relaxed text-sm mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-[#4a5568]">
                  ...
                  <span>Significant savings on annual tuition</span>
                </li>
                <li className="flex items-center gap-3 text-[#4a5568]">
                  <CheckCircle className="h-5 w-5 text-[#d4831f] flex-shrink-0" />
                  <span>One-time payment convenience</span>
                </li>
                <li className="flex items-center gap-3 text-[#4a5568]">
                  <CheckCircle className="h-5 w-5 text-[#d4831f] flex-shrink-0" />
                ...
                <li className="flex items-center gap-3 text-[#4a5568]">
                  <CheckCircle className="h-5 w-5 text-[#d4831f] flex-shrink-0" />
                  <span>Available for all grade levels</span>
                </li>
              </ul>
            </Card>
            ...
            <Card className="bg-[#faf7f2] border-0 shadow-lg rounded-2xl p-8 interactive-card">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-[#2d3748] mb-2">Financial Aid</h3>
                <p className="text-sm text-[#4a5568] mb-6">Supporting deserving students</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-[#4a5568]">
            ...
            <Card className="bg-[#faf7f2] border-0 shadow-lg rounded-2xl p-8 interactive-card">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-[#2d3748] mb-2">Our Commitment</h3>
                <Badge className="bg-[#c44569] text-white px-4 py-2 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 fade-in-section">
            <Card className="bg-[#faf7f2] border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-2xl text-center p-8 interactive-card">
              ...
              <Button className="bg-[#1f514c] hover:bg-[#2a6b65] text-white">Call Now</Button>
            </Card>
      ...
      <section className="py-20 bg-gradient-to-b from-[#faf7f2] to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-[#4a5568] mb-12 leading-relaxed">
            Join us in creating something extraordinary. Be part of our founding class and help
            shape the future of education in the Himalayas.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button
              size="lg"
