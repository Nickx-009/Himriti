  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] flex items-center justify-center px-6">
      <div className="max-w-md mx-auto text-center">
        ...
        <h1 className="text-2xl font-bold text-[#2d3748] mb-4">Something went wrong</h1>
        <p className="text-[#4a5568] mb-8 leading-relaxed">
          We're sorry, but there was an error loading this page. Please try refreshing or contact us
          if the problem continues.
        </p>
        <div className="space-y-4">
          <Button onClick={reset} className="bg-[#1f514c] hover:bg-[#2a6b65] text-white">
