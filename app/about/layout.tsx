...
export const metadata: Metadata = {
  ...
  description:
    'Discover the story behind Himriti Public School. Learn about our mission to provide world-class education in the Himalayas, our values, leadership team, and commitment to academic excellence.',
  keywords:
