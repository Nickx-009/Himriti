            ...
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-[#F2F2F2] rounded-lg focus:border-[#1f514c] focus:outline-none transition-colors">
              ...
              <div className="text-center">
                <Button size="lg" className="bg-[#1f514c] hover:bg-[#2a6b65] text-white px-12 py-4 text-lg h-14 btn-interactive">
                  Send Message
